...
{
    static const QColor BACKGROUND = QColor(24, 255, 0);
...
namespace CONF
{
    ...
    static const int CAMERASLACK = 90;
    static const int MOVERATE = 9;
    static const int BOUNCERATE = 6;
    static const int BOUNCEHEIGHT = 30;
    static const int STARTSIZE = 25;
    static const int WINSIZE = 150;
    static const int INVULNTIME = 1000;
    static const int GAMEOVERTIME = 4;
    static const int MAXHEALTH = 3;

    static const QString GAMEOVERTXT = "GAME OVER!";
    static const int NUMGRASS = 80;
    static const int NUMSQUIRRELS = 30;
    static const int SQUIRRELMINSPEED = 3;
    static const int SQUIRRELMAXSPEED = 7;
    static const int DIRCHANGEFREQ = 2;
    static const QString TITLE = "King eats queens Qt/C++";

    static const QString PATH_TO_GRASS_IMG[4] = {":/assets/sprite/grass1.png",
                                                 ":/assets/sprite/grass2.png"
                                                 ":/assets/sprite/grass3.png"
                                                 ":/assets/sprite/grass4.png"};
